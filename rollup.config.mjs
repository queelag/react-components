...
export default defineConfig({
  external: [
    ...
    '@queelag/web-components/elements/feedback/alert.element.js',
    '@queelag/web-components/elements/feedback/alert.dialog.element.js',
    '@queelag/web-components/elements/feedback/dialog.element.js',
    '@queelag/web-components/elements/feedback/meter.element.js',
